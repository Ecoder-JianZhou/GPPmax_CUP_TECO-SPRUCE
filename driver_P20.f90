            ...
            if(do_annual_mcmc) then
                ...
                if (iyear < 2014) then
                    ...
                    elseif (iyear .eq. 2021 .and. iday .eq. 1 .and. ihour .eq. 0) then
                        ...
                        do i = 2,3
                            if(i .eq. 2)then
                            st%sp(i)%s_vea = st%sp(i)%s_vea_8*1.4
                            ! st%sp(i)%s_ved = st%sp(i)%s_ved_8
                            st%sp(i)%s_jea = st%sp(i)%s_vea_8*1.4
                            ! st%sp(i)%s_jed = st%sp(i)%s_ved_8
                            st%sp(i)%Entrpy = st%sp(i)%Entrpy_8
                            st%sp(i)%Vcmax0 = st%sp(i)%Vcmax0_8
                            else
                            st%sp(i)%s_vea = st%sp(i)%s_vea_8*1.5
                            ! st%sp(i)%s_ved = st%sp(i)%s_ved_8
                            st%sp(i)%s_jea = st%sp(i)%s_vea_8*1.5
                            ! st%sp(i)%s_jed = st%sp(i)%s_ved_8
                            st%sp(i)%Entrpy = st%sp(i)%Entrpy_8
                            st%sp(i)%Vcmax0 = st%sp(i)%Vcmax0_8*0.9
                            endif
